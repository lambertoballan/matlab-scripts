function [centers, sse] = kmeans_bo(data, K, maxit)
    
% written by Liefeng Bo in University of Washington on 27/04/2011
% modified by Lamberto Ballan in University of Florence 15/04/2013
...
while iter < maxit
    ...
    tic;    
    [centers, sse] = kmeans_iter(data, centers);    
    t = toc;
...
function [centers, sse] = kmeans_iter(data, centers)
